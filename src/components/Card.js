...
const Card = ({ image, title, description }) => {
  return (
    <div className="bg-gradient-to-b from-[#95959C] hover:bg-gradient-to-t from-[#95959C] w-10/12 md:w-6/12 lg:w-4/12 md:px-[0.70px] px-[0.70px]">
      <div className="bg-[#0E0D0D] hover:bg-gradient-to-t from-zinc-600/25 size-full">
        <div className="px-8 py-4">
          ...
          <p className="text-[#B5B5B5] lg:w-[25vw] pb-2">{description}</p>
        </div>
      </div>
    </div>
  );
